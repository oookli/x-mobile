...
/*
	Navigation switch
*/
$("#nav-button").on("click",toggleNavigaton);
$("#search-button").on("click",toggleNavigaton);
...
function hidePopup(){
	$('#main-controls').find('.current').removeClass("current");
	$("#main-nav").addClass("hidden");
	$("#search-block").addClass("hidden");
	$("#overlay").addClass("hidden");
	return false;
